...
void LSM9DS1::init()
{
	...
	settings.gyro.scale             = LSM9DS1_GYRO_SCALE;
	settings.gyro.sampleRate        = LSM9DS1_GYRO_SAMPLE_RATE;
	settings.gyro.bandwidth         = LSM9DS1_GYRO_BANDWIDTH;
	settings.gyro.lowPowerEnable    = false;
	settings.gyro.HPFEnable         = LSM9DS1_GYRO_HPF_CUTOFF_ENABLED;
	settings.gyro.HPFCutoff         = LSM9DS1_GYRO_HPF_CUTOFF;
	...
	settings.accel.scale            = LSM9DS1_ACC_SCALE;
	settings.accel.sampleRate       = LSM9DS1_ACC_SAMPLE_RATE;
	settings.accel.bandwidth        = LSM9DS1_ACC_BANDWIDTH;
	settings.accel.highResEnable    = LSM9DS1_ACC_HIGH_RES_BANDWIDTH_ENABLED;
	settings.accel.highResBandwidth = LSM9DS1_ACC_HIGH_RES_BANDWIDTH;
	settings.mag.enabled            = true;
	settings.mag.scale              = LSM9DS1_MAG_SCALE;
	settings.mag.sampleRate         = LSM9DS1_MAG_SAMPLE_RATE;
	settings.mag.tempCompensationEnable = true;
	settings.mag.XYPerformance      = LSM9DS1_MAG_PERFORMANCE;
	settings.mag.ZPerformance       = LSM9DS1_MAG_PERFORMANCE;
	settings.mag.lowPowerEnable     = false;
	settings.mag.operatingMode      = LSM9DS1_MAG_OPERATING_MODE;
...
uint16_t LSM9DS1::begin(uint8_t agAddress, uint8_t mAddress, i2c_t3 &wirePort)
{
