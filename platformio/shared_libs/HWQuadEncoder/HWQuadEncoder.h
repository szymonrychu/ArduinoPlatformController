...
public:
	...
	typedef struct
	{
		...
		void (*positionROIEHandler)() = NULL;
		uint8_t positionRUIE;
		void (*positionRUIEHandler)() = NULL;
...
public:
	QuadEncoder(uint8_t encoder_ch = 0, uint8_t PhaseA_pin = 255, uint8_t PhaseB_pin = 255, uint8_t pin_pus = 0, uint8_t index_pin = 255, uint8_t home_pin = 255, uint8_t trigger_pin = 255);
