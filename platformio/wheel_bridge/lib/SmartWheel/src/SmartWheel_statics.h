...
#define DISTANCE_VPID_I DISTANCE_VPID_GAIN * 0.25
#define DISTANCE_VPID_D DISTANCE_VPID_GAIN * 0.0

#define ANGLE_DPID_GAIN 5.0
#define ANGLE_DPID_P ANGLE_DPID_GAIN * 5.0
#define ANGLE_DPID_I ANGLE_DPID_GAIN * 0.0
#define ANGLE_DPID_D ANGLE_DPID_GAIN * 0.0

#define ANGLE_VPID_GAIN 1.0
#define ANGLE_VPID_P ANGLE_VPID_GAIN * 1.0
#define ANGLE_VPID_I ANGLE_VPID_GAIN * 0.25
