...
#ifndef LSM9DS1_GYRO_SCALE
#define LSM9DS1_GYRO_SCALE 245
#endif
// gyro sample rate: value between 1-6
// 1 = 14.9    4 = 238
// 2 = 59.5    5 = 476
// 3 = 119     6 = 952
#ifndef LSM9DS1_GYRO_SAMPLE_RATE
#define LSM9DS1_GYRO_SAMPLE_RATE 6
#endif
// gyro cutoff frequency: value between 0-3
// Actual value of cutoff frequency depends
// on sample rate.
#ifndef LSM9DS1_GYRO_BANDWIDTH
#define LSM9DS1_GYRO_BANDWIDTH 0
#endif
// Gyro HPF cutoff frequency: value between 0-9
// Actual value depends on sample rate. Only applies
// if gyroHPFEnable is true.
#ifndef LSM9DS1_GYRO_HPF_CUTOFF_ENABLED
#define LSM9DS1_GYRO_HPF_CUTOFF_ENABLED false
#endif
#ifndef LSM9DS1_GYRO_HPF_CUTOFF
#define LSM9DS1_GYRO_HPF_CUTOFF 0
#endif



// accel scale can be 2, 4, 8, or 16
#ifndef LSM9DS1_ACC_SCALE
#define LSM9DS1_ACC_SCALE 2
#endif
// accel sample rate can be 1-6
// 1 = 10 Hz    4 = 238 Hz
// 2 = 50 Hz    5 = 476 Hz
// 3 = 119 Hz   6 = 952 Hz
#ifndef LSM9DS1_ACC_SAMPLE_RATE
#define LSM9DS1_ACC_SAMPLE_RATE 6
#endif
// Accel cutoff freqeuncy can be any value between -1 - 3. 
// -1 = bandwidth determined by sample rate
// 0 = 408 Hz   2 = 105 Hz
// 1 = 211 Hz   3 = 50 Hz
#ifndef LSM9DS1_ACC_BANDWIDTH
#define LSM9DS1_ACC_BANDWIDTH -1
#endif
// accelHighResBandwidth can be any value between 0-3
// LP cutoff is set to a factor of sample rate
// 0 = ODR/50    2 = ODR/9
// 1 = ODR/100   3 = ODR/400
#ifndef LSM9DS1_ACC_HIGH_RES_BANDWIDTH_ENABLED
#define LSM9DS1_ACC_HIGH_RES_BANDWIDTH_ENABLED false
#endif
#ifndef LSM9DS1_ACC_HIGH_RES_BANDWIDTH
#define LSM9DS1_ACC_HIGH_RES_BANDWIDTH 0
#endif

// mag scale can be 4, 8, 12, or 16
#ifndef LSM9DS1_MAG_SCALE
#define LSM9DS1_MAG_SCALE 4
#endif
...
// 2 = 2.5 Hz    6 = 40 Hz
// 3 = 5 Hz      7 = 80 Hz
#ifndef LSM9DS1_MAG_SAMPLE_RATE
#define LSM9DS1_MAG_SAMPLE_RATE 7
#endif
// magPerformance can be any value between 0-3
// 0 = Low power mode      2 = high performance
// 1 = medium performance  3 = ultra-high performance
#ifndef LSM9DS1_MAG_PERFORMANCE
#define LSM9DS1_MAG_PERFORMANCE 3
#endif
// magOperatingMode can be 0-2
// 0 = continuous conversion
// 1 = single-conversion
// 2 = power down
#ifndef LSM9DS1_MAG_OPERATING_MODE
#define LSM9DS1_MAG_OPERATING_MODE 0
#endif
...
public:
	...
	uint16_t begin(uint8_t agAddress = LSM9DS1_AG_ADDR(1), uint8_t mAddress = LSM9DS1_M_ADDR(1), i2c_t3 &wirePort = Wire); //By default use the default I2C addres, and use Wire port
