...
class WheelController(ROSNode, SafeSerialWrapper):
    ...
    def parse_serial(self, raw_data:String):
        ...
        transforms = [
            ...
            create_static_transform(self._base_frame_id, 'planner_base', 0.0, 0.0, 0.0, 0, 0, math.pi/2, rospy_time_now),
            create_static_transform(self._base_frame_id, self._laser_frame_id, 0.0, 0.08, 0.14, 0, 0, -math.pi/2, rospy_time_now),
        ...
        if computed_turning_point:
            ...
            transforms.append(create_static_transform(self._base_frame_id, self._computed_turning_point_frame_id, computed_turning_point.x, computed_turning_point.y, 0, 0, 0, 0, rospy_time_now))
        
        self._total_X -= mean_distance_delta * math.sin(self._total_yaw)
        self._total_Y += mean_distance_delta * math.cos(self._total_yaw)
